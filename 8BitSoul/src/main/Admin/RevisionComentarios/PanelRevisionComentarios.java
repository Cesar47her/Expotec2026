...
public class PanelRevisionComentarios extends JFrame {
    ...
    private BotonControlHUD btnMinimizar, btnMaximizar, btnCerrar;
    ...
    private void inicializarEstructura() {
        ...
        // SECCIÓN IZQUIERDA: LISTA DE COMENTARIOS
        ...
        btnVolver = new BotonNeonHUD("◀ VOLVER (ESC)", CYAN_NEON, true, 180, 48, 13);
